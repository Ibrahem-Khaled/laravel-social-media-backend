   ...
   <div class="content content-boxed">
    ...
    <div class="block block-rounded">
        <div class="block-header">
            <h3 class="block-title">Edit Comments</h3>
        </div>
                ...
                <div class="row push">
                    ...
                    <div class="col-lg-8 col-xl-5">
                            ...
                            <label for="one-profile-edit-name">Post</label>
                                ...
                                <div class="form-group">
                                    <select class="js-select2 form-control" id="" name="post_id" style="width: 100%;" data-placeholder="Choose one role..">
                                        ...
                                        <option @if ($post->id == $comment->post_id)
                                            selected
                            ...
                            <label for="one-profile-edit-name">Status</label>
                                ...
                                <div class="form-group">
                                    <select class="js-select2 form-control" id="" name="status" style="width: 100%;" data-placeholder="Choose one role..">
                                        <option></option><!-- Required for data-placeholder attribute to work with Select2 plugin -->
                                        <option @if ($comment->status == 'active')
                                            selected
                                        @endif value="active">active</option>
                                        <option @if ($comment->status == 'inactive')
                                            selected
                            ...
                            <label for="one-profile-edit-name">User</label>
                                ...
                                <div class="form-group">
                                    <select class="js-select2 form-control" id="" name="user_id" style="width: 100%;" data-placeholder="Choose one role..">
                                        ...
                                        <option @if ($user->id == $comment->user_id)
                                            selected
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="example-textarea-input" name="body" rows="4" placeholder="Enter Comment Body.." >{{$comment->body}}</textarea>
                        </div>
