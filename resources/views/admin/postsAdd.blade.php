                ...
                <div class="row push">
                    ...
                    <div class="col-lg-8 col-xl-5">
                        <div class="form-group">
                            ...
                            <input required  type="text" class="form-control" id="one-profile-edit-postname" name="title" placeholder="Enter post title.." value="">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="example-textarea-input" name="body" rows="4" placeholder="Enter Post Body.."></textarea>
                        </div>
