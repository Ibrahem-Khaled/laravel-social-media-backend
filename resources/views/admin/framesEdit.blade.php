   ...
   <div class="content content-boxed">
    ...
    <div class="block block-rounded">
        <div class="block-header">
            <h3 class="block-title">Edit Frame</h3>
        </div>
                ...
                <div class="row push">
                    ...
                    <div class="col-lg-8 col-xl-5">
                        <div class="form-group">
                            ...
                            <input required  type="text" class="form-control" id="one-profile-edit-framename" name="title" placeholder="Enter frame title.." value="{{$frame->title}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input required  type="text" class="form-control" id="one-profile-edit-email" name="price" placeholder="Enter frame price.." value="{{$frame->price}}">
                        </div>

                        <div class="form-group ">
                            <label for="example-flatpickr-custom">Expire Date</label>
                            <input required  type="text" class="js-flatpickr form-control bg-white" id="example-flatpickr-custom" name="expire" placeholder="Choice date of birth" data-date-format="Y-m-d" value="{{$frame->expire}}">
                        </div>

                        <div class="form-group">
                            <label>Frame Image</label>
                            <div class="push">
                                <img class="img-avatar" src="{{$frame->image}}" alt="">
                            </div>
