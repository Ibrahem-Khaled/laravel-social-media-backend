   ...
   <div class="content content-boxed">
    ...
    <div class="block block-rounded">
        <div class="block-header">
            <h3 class="block-title">Add New Entry</h3>
        </div>
        <div class="block-content">
            <form action="{{route('admin.entries.create')}}" method="POST" enctype="multipart/form-data" >
                @csrf
                <div class="row push">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-8 col-xl-5">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="one-profile-edit-avatar">Choose a new frame video</label>
                            </div>
