   ...
   <div class="content content-boxed">
    ...
    <div class="block block-rounded">
        ...
        <div class="block-content">
            <form action="{{route('admin.comments.create')}}" method="POST" enctype="multipart/form-data" >
                @csrf
                <div class="row push">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-8 col-xl-5">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="example-textarea-input" name="body" rows="4" placeholder="Enter Comment Body.."></textarea>
                        </div>
