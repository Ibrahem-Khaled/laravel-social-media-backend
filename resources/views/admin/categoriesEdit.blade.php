                ...
                <div class="row push">
                    ...
                    <div class="col-lg-8 col-xl-5">
                        <div class="form-group">
                            ...
                            <input required  type="text" class="form-control" id="one-profile-edit-categoryname" name="name" placeholder="Enter category name.." value="{{$category->name}}">
                        </div>
                            ...
                            <label for="one-profile-edit-name">Status</label>
                                ...
                                <div class="form-group">
                                    <select class="js-select2 form-control" id="" name="status" style="width: 100%;" data-placeholder="Choose one role..">
                                        ...
                                        <option @if ($category->status == 'active')
                                            selected
                                        @endif value="active">active</option>
                                        <option @if ($category->status == 'inactive')
                                            selected
                        ...
                        <div class="form-group">
                            ...
                            <input required  type="text" class="form-control" id="one-profile-edit-email" name="slug" placeholder="Enter category slug.." value="{{$category->slug}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="push">
                                <img class="img-avatar" src="{{$category->image}}" alt="">
                            </div>
