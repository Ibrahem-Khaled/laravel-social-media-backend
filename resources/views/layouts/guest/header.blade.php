                ...
                <div class="content-header">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <a class="font-w600 font-size-h5 tracking-wider text-dual mr-3" href="">
                            @lang('landing.find')<span class="font-w400">@lang('landing.me')</span>
                        </a>
                        <!-- END Logo -->
                    </div>
                    <!-- END Left Section -->
                            ...
                            <ul class="nav-main nav-main-horizontal nav-main-hover">
                                <li class="nav-main-item">
                                    <a class="nav-main-link active">
                                        ...
                                        <span class="nav-main-link-name">@lang('landing.home')</span>
                                    </a>
                                </li>
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="javascript:void(0)">
                                        ...
                                        <span class="nav-main-link-name">@lang('landing.how it works')</span>
                                    </a>
                                </li>
                                ...
                                <li class="nav-main-item join-now">
                                    <a class="nav-main-link" href="javascript:void(0)">
                                        <i class="nav-main-link-icon si si si-login"></i>
                                        <span class="nav-main-link-name">@lang('landing.join now')</span>
                                    </a>
                                </li>
